...
class Place(object):
	...
	def address_to_latlng(self, address):
		g = geocoder.bing(address, key='AulPV9NBNr8-52wRhtxSH-XOp6Y-Dee1ThiHSCOvsOPYIsLU7MGW8SHlqo7SOJ-M')
		return (g.latlng)

	def  query(self, address):
		latlng =self.address_to_latlng(address)
		query_url = 'https://en.wikipedia.org/w/api.php?action=query&list=geosearch&gsradius=5000&gscoord={0}%7C{1}&gslimit=20&format=json'.format(latlng[0], latlng[1])
